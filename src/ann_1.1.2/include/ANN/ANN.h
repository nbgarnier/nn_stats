...
//----------------------------------------------------------------------
// Edit(s) NG
// lines 245+ : for definitions regarding self matches
// lines 255+ : for setting these dynamically
// lines 359 vs 383 : for definitions of the norm, changed to Euclidian on 2024-10-08
//----------------------------------------------------------------------
...
#define ANNversion 		"1.1.2p"			// ANN version and information
#define ANNversionCmt	"multi-thread safe"
#define ANNcopyright	"David M. Mount and Sunil Arya / Nicolas B. Garnier"
#define ANNlatestRev	"Oct 8th, 2024"
...
// 2014-01-21, NG, replaced by :
// extern ANNbool	ANN_ALLOW_SELF_MATCH;
// 2014-06-03, NG, moved back to original :
const ANNbool	ANN_ALLOW_SELF_MATCH	= ANNtrue; // 2024-10-07 changed to True for this use

// following are functions inside the ANN library to change the variable ANN_ALLOW_SELF_MATCH;
// commented out 2014-06-03
/*
#ifdef __cplusplus
extern "C" {
#endif 
ANNbool set_ANN_ALLOW_SELF_MATCH(int mode);
ANNbool get_ANN_ALLOW_SELF_MATCH(void);
#ifdef __cplusplus
}
#endif 
*/
...
public:
	...
	virtual void annkSearch(			// approx k near neighbor search
		...
		int             core=0          // 2021-12-01: adaptation for pthread
	...
	virtual int annkFRSearch(			// approx fixed-radius kNN search
		...
		double			eps=0.0,		// error bound
		int             core=0          // 2021-12-03: adaptation for pthread
		) = 0;							// pure virtual (defined elsewhere)
...
public:
	...
	void annkPriSearch( 				// priority k near neighbor search
		...
		ANNdistArray	dd,				// dist to near neighbors (modified)
		double			eps=0.0,		// error bound
		int             core=0);        // 2021-12-08: adaptation for pthread
