...
public:
	...
	virtual void ann_search(ANNdist, int core=0);			// standard search
	virtual void ann_pri_search(ANNdist, int core=0);		// priority search
	virtual void ann_FR_search(ANNdist, int core=0); 		// fixed-radius search
};
