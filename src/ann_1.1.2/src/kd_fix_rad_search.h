...
extern __thread ANNpoint ANNkdFRQ;	// query point (static copy) 
            // 2021-12-01: adapted for pthread : allocated in ANN_wrapper.cpp
            // this is the only variable used outside of ANN_kd_fix_rad_search.cpp
            // it is refered to in bd_fix_rad_search.cpp
#endif
