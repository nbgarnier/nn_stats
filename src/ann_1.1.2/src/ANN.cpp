...
//----------------------------------------------------------------------
// 2014 edit NG
// lines 50-80 : for dynamically changing the selfmatch defition (WIP)
//----------------------------------------------------------------------
...
// following added NG, 2014-01-29:
// commented out 2014-06-03
// ANNbool	ANN_ALLOW_SELF_MATCH = ANNfalse;

//----------------------------------------------------------------------
//  access to and modify ANN_ALLOW_SELF_MATCH
//  addded NG 2014-01-29
// commented out 2014/06/03
//----------------------------------------------------------------------
void set_ANN_ALLOW_SELF_MATCH_TRUE(void)
{ //  ANN_ALLOW_SELF_MATCH = ANNtrue;
    std::cout << "not implemented";
}

void set_ANN_ALLOW_SELF_MATCH_FALSE(void)
...
{   if (mode)
    {   set_ANN_ALLOW_SELF_MATCH_TRUE(); }
    else 
    {   set_ANN_ALLOW_SELF_MATCH_FALSE(); }
    
    std::cout << "coucou, I've just set " << ANN_ALLOW_SELF_MATCH << "\n";
    return(ANN_ALLOW_SELF_MATCH);
}

ANNbool get_ANN_ALLOW_SELF_MATCH(void)
{   std::cout << "coucou, I've just read " << ANN_ALLOW_SELF_MATCH << "\n";
    return(ANN_ALLOW_SELF_MATCH);
}
...
//		computed using partial distance calculations, and not this
//		procedure.)
//----------------------------------------------------------------------
