...
public:
	...
	virtual void ann_search    (ANNdist, int core=0) = 0;	// tree search // 2021-11-30: adapted to pthread
	virtual void ann_pri_search(ANNdist, int core=0) = 0;	// priority search
	virtual void ann_FR_search (ANNdist, int core=0) = 0;	// fixed-radius search // 2021-12-03: adapted to pthread
...
public:
	...
	virtual void ann_search(ANNdist, int core=0);		// standard search // 2021-11-30: adapted to pthread
	virtual void ann_pri_search(ANNdist, int core=0);	// priority search // 2021-12-08: adapted to pthread
	virtual void ann_FR_search(ANNdist, int core=0);	// fixed-radius search // 2021-12-03: adapted to pthread
};
